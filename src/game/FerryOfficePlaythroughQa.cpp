    ...
    bool vehicleRuntimeAdapterEnabled)
{
    ...
    actionOk = TriggerInteraction(scene, FerryOffice::Names::HarborPartsCrate, message);
    RecordActionStep(result,
        scene,
        "harborPartsPickedUp",
        {WorldFlag::HarborPartsPickedUp},
    ...
    actionOk = TriggerInteraction(scene, FerryOffice::Names::FerryOfficePartsShelf, message);
    RecordActionStep(result,
        scene,
    ...
    actionOk = TriggerInteraction(scene, FerryOffice::Names::FerryOfficeWorkBoard, message);
    RecordActionStep(result,
        scene,
    ...
    actionOk = TriggerInteraction(scene, FerryOffice::Names::StormPumpSwitch, message);
    RecordActionStep(result,
        scene,
        "stormPumpReset",
        {WorldFlag::StormPumpReset},
    ...
    actionOk = TriggerInteraction(scene, FerryOffice::Names::StormPumpTicket, message);
    RecordActionStep(result,
        scene,
    ...
    actionOk = TriggerInteraction(scene, FerryOffice::Names::LowDockDrainMarker, message);
    RecordActionStep(result,
        scene,
        "lowDockDrainCleared",
        {WorldFlag::LowDockDrainCleared},
    ...
    actionOk = TriggerInteraction(scene, FerryOffice::Names::FerryOfficeDrainLog, message);
    RecordActionStep(result,
        scene,
        "lowDockDrainLogged",
        {WorldFlag::LowDockDrainLogged},

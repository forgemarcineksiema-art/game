...
struct FerryOfficeVehicleRuntimeComparisonResult {
    ...
    struct BroadRouteCheck {
        std::string backendName;
        bool passed = false;
        bool collisionResponseBacked = false;
        bool turnCompleted = false;
        bool reverseCompleted = false;
        bool readabilityStable = false;
        bool blockedByAuthoredEdge = false;
        bool unconstrainedWouldCrossEdge = false;
        ...
        float edgeLimitZ = 0.0f;
        float unconstrainedPeakZ = 0.0f;
        float unconstrainedMinZ = 0.0f;
        float constrainedPeakZ = 0.0f;
        float constrainedMinZ = 0.0f;
    ...
    struct ExtendedRouteCheck {
        std::string backendName;
        bool passed = false;
        std::string inputScriptName;
        bool inputRecorded = false;
        std::string authoredRouteId;
        int frameCount = 0;
        float routeProgressMeters = 0.0f;
        int turnCount = 0;
        bool reverseCompleted = false;
        float reverseDistance = 0.0f;
        bool cameraResetApplied = false;
        int cameraResetFrame = 0;
        bool readabilityStableAfterReset = false;
        float maxCameraYawDeltaBeforeResetDegrees = 0.0f;
        float maxCameraYawDeltaAfterResetDegrees = 0.0f;
        bool roadEdgeCollisionBacked = false;
        int edgeContactFrames = 0;
        std::string blockedEdgeId;
        std::vector<std::string> authoredEdgeIds;
        engine::Vec3 finalPosition;
    ...
    std::vector<ExtendedRouteCheck> extendedRouteChecks;

...
struct TargetSliceObjectiveQaResult {
    ...
    std::string riskyActionId;
    std::string riskyActionInteractableName;
    std::string riskyActionMessage;
    bool riskyActionAttempted = false;
    bool riskyActionTriggered = false;
    int framesToAction = -1;
    std::string responseStateId;
    std::string responseSummary;
    bool localResponseActive = false;
    int framesToResponse = -1;
    std::string exitRecoveryStateId;
    std::string exitInteractableName;
    std::string exitRecoveryMessage;
    bool exitRecoveryComplete = false;
    int framesToExit = -1;

...
- After v0.98, Jolt remains the preferred production vehicle-runtime candidate: Jolt CTest, parity/contact/vehicle/runtime QA, Jolt playthrough QA, preferred-wrapper smoke, route/brake/reverse/steering/camera driving-feel checks, and route-pace sensitivity probes pass against the current Ferry Office scene. Jolt camera yaw lag is 12.24 degrees under a 15-degree QA ceiling; route pace remains 212 frames at throttle 0.72, 0.86, and 1.0.

...
- After v0.99, Jolt remains the preferred production vehicle-runtime candidate: Jolt CTest, parity/contact/vehicle/runtime QA, Jolt playthrough QA, preferred-wrapper smoke, route/brake/reverse/steering/camera driving-feel checks, route-pace sensitivity probes, and the conservative straight-drive assist pass against the current Ferry Office scene. Jolt camera yaw lag is 12.24 degrees under a 15-degree QA ceiling; route pace is now 169 frames at normal throttle versus 139 deterministic.

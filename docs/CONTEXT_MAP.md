...
- `python tools/scene_report.py`: passed; scene has 9 colliders, 24 visual placeholders, 10 mesh assets, 43 mesh instances, 6 interactables, 1 traversal affordance, 1 vehicle, 6 route markers, and 5 objective markers.
- `python tools/validate_scene.py`: passed.
- `python tools/validate_assets.py`: passed.
- `python tools/scale_audit.py`: passed, no suspicious scale issues.
- `python tools/mesh_report.py`: passed, 10 referenced model files.

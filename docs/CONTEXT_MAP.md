...
- After v0.97, Jolt remains the preferred production vehicle-runtime candidate: Jolt CTest, parity/contact/vehicle/runtime QA, Jolt playthrough QA, preferred-wrapper smoke, and route/brake/reverse/steering/camera driving-feel checks pass against the current Ferry Office scene. Jolt camera yaw lag is now 12.24 degrees under a 15-degree QA ceiling; route pace remains 212 frames to checkpoint.

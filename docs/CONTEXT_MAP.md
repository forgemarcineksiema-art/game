...
- After v0.96, Jolt remains the preferred production vehicle-runtime candidate: Jolt CTest, parity/contact/vehicle/runtime QA, Jolt playthrough QA, preferred-wrapper smoke, and route/brake/reverse/steering/camera driving-feel checks pass against the current Ferry Office scene.

...
- Full default Jolt vehicle integration remains deferred until fuller controls/camera, steering, obstacle, road-edge collision response, and manual-feel evidence proves the switched path is worth promoting. v0.37 proves opt-in live selection for the authored service vehicle, v0.37.1 fixes the first obvious tap/coast/reverse control bug, v0.48 proves the deterministic first-job runtime vehicle beat, v0.49 proves the same beat through opt-in Jolt, v0.59 closes the scripted obstacle-progress gap, v0.99 narrows the Jolt straight-route pace gap to 169 versus 139 deterministic, and the post-v0.99 gate proves the current route stays clear of two authored road-edge probes. This is still not default Jolt replacement, full gameplay collision, complete tuning, or a complete road model.

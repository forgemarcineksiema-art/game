...
class TargetSliceObjectiveQaTests(unittest.TestCase):
    def test_report_requires_live_focus_interact_and_completion_evidence(self) -> None:
        report = {
            ...
            "focus": {
                "acquired": True,
                "name": "Cinder Harbor Marker",
                "prompt": "Confirm Cinder Harbor Reach",
                "distance": 1.1,
            },
            "interaction": {
                "triggered": True,
            ...
            "localResponse": {
                "stateId": "cinder-local-alerted",
                "active": True,
                "framesToResponse": 82,
                "summary": "response=cinder-local-alerted",
            },
            "exitRecovery": {
                "stateId": "harbor-scar-escape-confirmed",
                "complete": True,
                "interactableName": "Harbor Scar Escape Marker",
                "framesToExit": 111,
            ...
            "final": {
                "objectiveId": "inspect-cinder-cache-marker",
                "objectiveComplete": True,
                "completionSummary": "complete=true role=target-slice-authored-objective targetObjective=inspect-cinder-cache-marker consequence=cinder-harbor-confirmed riskyAction=cinder-cache-risk-response complete=true responseState=cinder-local-alerted active=true exitRecovery=harbor-scar-escape-confirmed complete=true",
                "completionEventText": "Target-slice objective confirmed: cinder-harbor-marker",
    ...
    def test_report_rejects_direct_completion_without_focus(self) -> None:
        report = {
            ...
            "final": {
                "objectiveId": "inspect-cinder-cache-marker",
                "objectiveComplete": True,
                "completionSummary": "complete=true targetObjective=inspect-cinder-cache-marker riskyAction=cinder-cache-risk-response responseState=cinder-local-alerted exitRecovery=harbor-scar-escape-confirmed",
                "completionEventText": "Target-slice objective confirmed: cinder-harbor-marker",
    ...
    def test_report_rejects_old_objective_only_evidence_without_risky_action(self) -> None:
        report = {
            ...
            "final": {
                "objectiveId": "inspect-cinder-cache-marker",
                "objectiveComplete": True,
                "completionSummary": "complete=true role=target-slice-authored-objective targetObjective=inspect-cinder-cache-marker consequence=cinder-harbor-confirmed",
                "completionEventText": "Target-slice objective confirmed: cinder-harbor-marker",
                "playerPosition": {"x": 0.4, "y": 0.0, "z": 1.55},
            },
            "error": "",
